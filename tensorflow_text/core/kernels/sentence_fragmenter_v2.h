...
// is potentially an end-of-sentence.
//
// Example:
//
//   Document text:
...
#ifndef THIRD_PARTY_TENSORFLOW_TEXT_CORE_KERNELS_SENTENCE_FRAGMENTER_V2_H_
#define THIRD_PARTY_TENSORFLOW_TEXT_CORE_KERNELS_SENTENCE_FRAGMENTER_V2_H_
  ...
  string print_state() const {
    switch (state_) {
      ...
      case COLLECTING_TERMINAL_PUNC:
        return "COLLECTING_TERMINAL_PUNC";
      case COLLECTING_CLOSE_PUNC:
        return "COLLECTING_CLOSE_PUNC";
    }
  }
...
class SentenceFragmenter {
 public:
  ...
  SentenceFragmenter(absl::string_view document) : document_(document) {}
